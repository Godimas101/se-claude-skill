...
### Internal
- [CSHARP_PATTERNS.md](../../se-csharp/references/patterns.md) — compiled mod C# patterns; project setup applies to PB scripts too
- [TSS_PATTERNS.md](../../se-tss/references/patterns.md) — Text Surface Script patterns for writing to LCD surfaces from a PB
