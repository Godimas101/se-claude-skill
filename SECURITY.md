...
- private chat logs or private user data
- email addresses, phone numbers, home addresses, or account details
...
Use GitHub's private security reporting if available, or contact the repository owner privately with a minimal description of the issue.
