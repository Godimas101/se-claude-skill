...
**Start here:** [SBC_TEMPLATES.md](SBC_TEMPLATES.md)
...
**Start here:** [CSHARP_PATTERNS.md](CSHARP_PATTERNS.md) · [SKILL.md](SKILL.md)
...
**Full guide:** [SBC_TEMPLATES.md — Cross-Mod Asset References](SBC_TEMPLATES.md)
